...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::get('/reset-request', [ForgotPasswordController::class, 'forgotRequest'])->name('api.auth.reset.request');
    Route::post('/reset-confirm', [ForgotPasswordController::class, 'forgotConfirm'])->name('api.auth.reset.confirm');
